@extends('layouts.app')
@section('title', 'Toernooien eigen overzicht')
@section('content')
        ...
        <div class="container">
            <div class="row contact-details">
                <div class="col-12">
                    ...
                    <h2 class="jumbotron-heading text-center"><strong>Overzicht eigen toernooien</strong></h2>
                    <div class="divider"></div>
                    <div class="row">
                        <div class="col-sm-12">
                            <form method="GET" action="{{ route('ownTournaments') }}">
                                <div class="input-group stylish-input-group">
                                    <input type="text" class="form-control" placeholder="Eigen toernooi zoeken"
                                           name="search">
                        ...
                        <div class="row justify-content-center">
                            ...
                            @empty
                                <div class="col-md-12 col-sm-6 text-center">
                                    <h4>Er zijn momenteel geen eigen toernooien.</h4>
                                </div>
                            @endforelse
                        </div>
                    </div>
